...
const generateMetadataJsonFile = (cipJsonFilePath, metadataFilePath, actionType, releaseNumber, releaseName, offChainStorage, offChainStoragePath, cipRootHash, secretKey, publicKey) => {
  try {
